...
public class Receipt {
    ...
    public double getTotalCost() {
        ...
        totalCost += Math.min(RATE_CHANGE_DISTANCE, totalKms) * preRateChange * peakTimeMultiple;
        totalCost += Math.max(0, totalKms - RATE_CHANGE_DISTANCE) * postRateChange * peakTimeMultiple;
